...
<body>
  <div id="wrapper">
    ...
    <div class="Cuerpo aviso">
      <form action="MostrarMensaje2.php" method="post">
        ...
        <div class="control-group">
          ...
          <?php
            ...
            if($con){
              $consulta = "select * from mensaje where men_estado='ENVIADO'";
          ...
          ?>
                  ...
                  ?>
                    <tr class="mensaje">
                      <td align="center" valign="middle" class="mensaje">
                        <input type="radio" name="group1" value="<?php echo $row["men_id"] ?>">
                      </td>
                      <td align="center" valign="middle" class="mensaje">
            ...
            <?php 
              ...
              alerta_javascript_direccionado("No se pudo Conectar a la BD, Intentelo mas tarde.","AdminMensajelan.php");
          ?>
          </div>
        </div>
        <div class="control-group BotonForm">
          <div class="controls">
            <button type="submit" class="btn btn-success">Mostrar Mensaje</button>
          </div>
        </div>
        <div class="control-group">
          <div class="controls">
