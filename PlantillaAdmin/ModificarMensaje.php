...
<body>
  <div id="wrapper">
    ...
    <div class="Cuerpo aviso">
      <form action="ModificarMensaje2.php" method="post">
                  ...
                  ?>
                    <tr class="mensaje">
                      <td align="center" valign="middle" class="mensaje">
                        <input type="radio" name="group1" value="<?php echo $row["men_id"] ?>" rquired>
                      </td>
                      <td align="center" valign="middle" class="mensaje">
        ...
        <div class="control-group BotonForm">
          <div class="controls">
            <button type="submit" class="btn btn-success">Modificar Mensaje</button>
          </div>
        </div>
        <div class="control-group">
          <div class="controls">
