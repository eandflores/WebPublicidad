...
<body>
    ...
    <?php include("MainNav.php"); ?>
  	<div>
      <form class="form-horizontal Cuerpo" method="post" action="AgregarProxy2.php">
        <legend>Agregar Proxy</legend>
        <div class="control-group success">
          <label class="control-label" for="inputNombre">Nombre</label>
          <div class="controls">
            <input type="text" id="inputNombre" name="Nombre" placeholder="Nombre" maxlength="20" required>
          </div>
        </div>
        <div class="control-group success">
          <label class="control-label" for="inputDireccion">Dirección</label>
          <div class="controls">
            <input type="text" id="inputDireccion" name="Direccion" placeholder="Dirección" maxlength="20" required>
          </div>
        </div>
